...
#teacher approval
def teacher_waits_approval(request):
    return render(request, 'school/teacher_wait_for_approval.html')


#student approval
def student_waits_approval(request):
    ...
    if request.method == 'POST':
        if student_form.is_valid():
            ...
            try:
                ...
                user.save()
                messages.success(request, "Application succesful")
                return redirect(reverse('student_waits_approval'))
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                ...
                user.save()
                messages.success(request, "registration Successfully pending admin approval ")
                return redirect(reverse('teacher_waits_approval'))
...
#             my_student_group = Group.objects.get_or_create(user_type='3')
