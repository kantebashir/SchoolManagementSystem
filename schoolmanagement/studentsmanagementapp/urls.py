...
from studentsmanagementapp.EditResultView import EditResultView
...
urlpatterns = [
    ...
    path("student_signup_page", views.student_signup_page, name='student_signup_page'),
    path("teacherclick",views.teacherclick, name='teacherclick'),
    path("teacher_signup", views.teacher_signup, name='teacher_signup'),
    path("teacher_waits_approval", views.teacher_waits_approval, name='teacher_waits_approval'),
    path("student_waits_approval", views.student_waits_approval, name='student_waits_approval'),
